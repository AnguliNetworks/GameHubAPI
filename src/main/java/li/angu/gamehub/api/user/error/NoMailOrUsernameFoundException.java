 ...
 */
public class NoMailOrUsernameFoundException extends RuntimeException {

    public NoMailOrUsernameFoundException() {
        super("Bitte gib Deine Mail oder Deinen Benutzernamen an.");
    }
}
